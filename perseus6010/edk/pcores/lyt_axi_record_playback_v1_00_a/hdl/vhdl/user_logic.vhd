...
--   31:8 rsvd R
--   7:0 ProgFullThresAssert R W O=ov8_ProgFullThresAssert_p

-- BASEADDR + 0x50   PROG_FULL_THRES_NEGATE    20
--   31:8 rsvd R
--   7:0 ProgFullThresNegate R W O=ov8_ProgFullThresNegate_p
...
entity user_logic is
  ...
  (
    ...
    ov8_ProgFullThresAssert_p : out std_logic_vector(7 downto 0);
    ov8_ProgFullThresNegate_p : out std_logic_vector(7 downto 0);
 ...
 begin
  ...
  if Bus2IP_Clk'event and Bus2IP_Clk = '1' then
    ...
    --if (Bus2IP_Resetn = '0') then
      ...
      UnderRunFlag_s <= '0';
      OverRunFlag_s <= '0';
      v8_ProgFullThresAssert_s <= x"00";
      v8_ProgFullThresNegate_s <= x"00";
      RecTrigMux_s <= '0';
      RecSoftTrig_s <= '0';
      PlayTrigMux_s <= '0';
      PlaySoftTrig_s <= '0';
      ...
      case slv_reg_write_sel is
        ...
        when OneHotVector(19,36) =>
          if (Bus2IP_BE(0) = '1') then
            v8_ProgFullThresAssert_s <= Bus2IP_Data(7 downto 0);
          end if;

        when OneHotVector(20,36) =>
          if (Bus2IP_BE(0) = '1') then
            v8_ProgFullThresNegate_s <= Bus2IP_Data(7 downto 0);
          end if;
 ...
 begin
   case slv_reg_read_sel is
        ...
        when OneHotVector(19,C_NUM_REG) =>
          ...
          slv_ip2bus_data(7 downto 0) <= v8_ProgFullThresAssert_s;

        when OneHotVector(20,C_NUM_REG) =>
          slv_ip2bus_data(31 downto 8) <= x"000000";
          slv_ip2bus_data(7 downto 0) <= v8_ProgFullThresNegate_s;
