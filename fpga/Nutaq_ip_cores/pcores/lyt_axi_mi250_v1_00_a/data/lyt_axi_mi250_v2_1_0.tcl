...
set srcCore1 $packagesfilesDir/mi250_wrapper_p.vhd
set srcCore2 $coresDir/mi250_top.ngc
...
set ucfFile2 "lyt_axi_mi250_lx240_sx315_v2_1_0.ucf" 
set ucfFile1 "lyt_axi_mi250_lx550_sx475_v2_1_0.ucf" 
...
proc generate_corelevel_ucf {mhsinst} {
    ...
    foreach line $data {
        if [string match "Device: xc6vlx240t" $line] {
          set deviceFileName "./ucf/lyt_axi_mi250_lx240_sx315_v2_1_0.ucf"  
        } 
        ...
        if [string match "Device: xc6vlx550t" $line] {
           set deviceFileName "./ucf/lyt_axi_mi250_lx550_sx475_v2_1_0.ucf"  
        }
