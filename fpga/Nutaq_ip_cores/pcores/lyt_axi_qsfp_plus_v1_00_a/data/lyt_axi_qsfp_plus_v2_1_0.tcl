...
set destcore $netlistDestCores/lyt_axi_qsfp_plus_v1_00_a
...
set ucfFile2 "lyt_axi_qsfp_plus_lx240_sx315_v2_1_0.ucf" 
set ucfFile1 "lyt_axi_qsfp_plus_lx550_sx475_v2_1_0.ucf" 
...
proc generate_corelevel_ucf { mhsinst } {
    ...
    foreach line $data {
        if [string match "Device: xc6vlx240t" $line] {
          set deviceFileName "./ucf/lyt_axi_qsfp_plus_lx240_sx315_v2_1_0.ucf"  
        } 
        ...
        if [string match "Device: xc6vlx550t" $line] {
           set deviceFileName "./ucf/lyt_axi_qsfp_plus_lx550_sx475_v2_1_0.ucf"  
        }
